...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gtk_test: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gtk_test ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/gameManagement.o: gameManagement.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gameManagement.o gameManagement.c
...
${OBJECTDIR}/timer.o: timer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timer.o timer.c
